...
public class ComponentsGenerator {
	...
	public LayoutComponents createEntryLayout(String labelText, double labelRatio, double textFieldRatio,
			boolean isPassword) {
	...
	public LayoutComponents createButtonLayout(String buttonText, double spaceRatio, double buttonRatio,
			double sizeRatio, boolean isSolidButton, int y_offset, int h_offset) {
		JPanel panel = new JPanel();
		panel.setLayout(null);
		panel.setBackground(Constants.background_color);
	...
	public LayoutComponents createLabelLayout(String labelText, double spaceRatio, double labelRatio, double sizeRatio,
			int y_offset) {
		JPanel panel = new JPanel();
		panel.setLayout(null);
		panel.setBackground(Constants.background_color);
	...
	public LayoutComponents createDropdownLayout(String labelText, double labelRatio, double dropdownRatio,
	...
	public LayoutComponents createDatepicker(String labelText, double labelRatio, double dropdownRatio) {
		JPanel panel = new JPanel();
		panel.setLayout(null);
		panel.setBackground(Constants.background_color);
		...
		datePicker.getJFormattedTextField().setFont(new Font("Arial", Font.PLAIN, Constants.input_label_size));
		datePicker.setBorder(new LineBorder(Constants.border_color, 2));
		...
		label.setBounds(0, verticalCenter, labelWidth, labelHeight);
		datePicker.setBounds(labelWidth, verticalCenter + 15, (int) (dropdownWidth * 0.5), dropdownHeight - 30);

		datePicker.setPreferredSize(new Dimension((int) (dropdownWidth * 0.5), entry_layout_height - 30));
		datePicker.getComponent(0)
				.setPreferredSize(new Dimension((int) (dropdownWidth * 0.5 * 0.8), entry_layout_height - 30));
		datePicker.getComponent(1)
				.setPreferredSize(new Dimension((int) (dropdownWidth * 0.5 * 0.2), entry_layout_height - 30));

		panel.add(label);
		panel.add(datePicker);

		return new LayoutComponents(panel, label, datePicker);
	}
